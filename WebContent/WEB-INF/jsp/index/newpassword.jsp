...
<script type="text/javascript"
	src="<c:url value='/js/newpassword-form.js'/>"></script>
<script type="text/javascript">
...
<body>
	...
	<div id="page">
		<div id="content">
			<form id="newpassword_form" class="width510"
				...
				<fieldset>
					...
					<div class="single_form_element">
						...
						<input id="pass2" class="input_border width285" type="password"
							...
							class="description">Confirme a senha</span>
					</div>
					<input type="hidden" name="newPasswordKey"
						value="${newPasswordKey}" /> <input class="button" type="submit"
						value="Confirmar">
				</fieldset>
			</form>
		</div>
