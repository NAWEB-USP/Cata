...
<script type="text/javascript"
	src="<c:url value='/js/recover-form.js'/>"></script>
<script type="text/javascript">
...
<body>
	...
	<div id="page">
		<div id="content">
			<form id="recover_form" class="width510"
				action="<c:url value='/recover'/>" method="post">
				<fieldset>
					<legend>Esqueceu sua senha?</legend>
					<div class="single_form_element">
						<label class="label" for="email">Digite o e-mail que você
							usa para autenticar-se no CATA. Um <i>link</i> com instruções
							para recuperar seu acesso será enviado.
						</label> <br />
						<br /> <input id="email" class="input_border width285"
							type="text" maxlength=100 name="email" /><br />
					</div>
