...
<body>
	...
	<div id="page">
		<div id="content">
			...
			<div id="social">
				<!-- Facebook -->
				<fb:like send="false" layout="button_count" width="35"
			...
			<div id='coin-slider'>
				...
				<a href="<c:url value='/signup'/>">
					...
					<span><b>Cadastre suas próprias sugestões de estilo</b><br>
				...
				<form id="login_form" action="<c:url value='/login'/>" method="post">
					<fieldset>
						...
						<center>
							...
							<div class="small">
								Novo por aqui? <a href="<c:url value='/signup'/>">Cadastre-se</a>
							</div>
						</center>
					</fieldset>
				</form>
