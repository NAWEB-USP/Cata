...
<body>
	...
	<div id="page">
		<div id="content">
			<h1>
				<c:out value="${userSession.user.name}" />
			</h1>
			<h2>
				(
				<c:out value="${userSession.user.email}" />
				)
			</h2>
			<div class="indentation">
				<button type="button" class="button"
					onclick="window.location.href='<c:url value='/user/changepassword'/>'">Alterar
					senha</button>
				<br /> <b>Regras cadastradas por você</b><br />
				<div class="grid">
				...
				<form action="<c:url value='/rules/editrule'/>" method="post"
					...
					<button class="button"
						onclick="window.location.href='<c:url value='/rules/newrule'/>';return false;">Cadastrar
						nova regra</button>
				</form>
				<form action="<c:url value='/rules/deleterule'/>" method="post"
					id="deleterule-form" style="display: none"></form>
